...
{
    case 1:
		require(__DIR__ . '/../Vista/LoginUnificado.php');
    	break;
    case 2:
    	// VALIDAR reCAPTCHA
        ...
        if ($role == 'admin') {
            ...
            // VALIDAR INICIO DE SESIÓN EMPLEADO
            $usuario = $con->loginEmpleados($cnn, $_POST['Usuario'], $_POST['Clave']);
            ...
            header('location:../Vista/MensajeUsuarios.php?error=invalid_role');
        }
        break;
    case 3:
        // CERRAR SESIÓN
